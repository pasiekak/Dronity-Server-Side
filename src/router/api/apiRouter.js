...
const clientController =
  new (require("../../controllers/model-controllers/ClientController"))();
const clientRouter = new (require("./BaseRouter"))(clientController);

const operatorController =
  new (require("../../controllers/model-controllers/OperatorController"))();
const operatorRouter = new (require("./BaseRouter"))(operatorController);

const roleController =
  new (require("../../controllers/model-controllers/RoleController"))();
const roleRouter = new (require("./BaseRouter"))(roleController);

const addressController =
  new (require("../../controllers/model-controllers/AddressController"))();
const addressRouter = new (require("./BaseRouter"))(addressController);

const commissionController =
  new (require("../../controllers/model-controllers/CommissionController"))();
...
const statisticsController =
  new (require("../../controllers/model-controllers/StatisticsController"))();
